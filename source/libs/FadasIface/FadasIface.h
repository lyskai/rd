...
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(FadasIface_FadasCvtYUV_UYVYtoRGB)(remote_handle64 _h, const uint8_t* src, int srcLen, const FadasIface_FadasImgProps_t* srcProps, uint8_t* dst, int dstLen, uint32_t dstStride) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(FadasIface_FadasCvtYUV_UYVYtoYUV)(remote_handle64 _h, const uint8_t* src, int srcLen, const FadasIface_FadasImgProps_t* srcProps, uint8_t* dst, int dstLen, uint32_t dstStride) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(FadasIface_FadasCvtYUV_UYVYtoNV12)(remote_handle64 _h, int32_t srcFd, uint32_t srcLen, uint32_t offset, const FadasIface_FadasImgProps_t* srcProps, int32_t dstFd, uint32_t dstLen, uint32_t dstStride) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(FadasIface_FadasCvtYUV_CreateWorkers)(remote_handle64 _h, uint64* addr, int32 num_threads, FadasIface_FadasCvtYUVPipeline_e type) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(FadasIface_FadasCvtYUV_DestroyWorkers)(remote_handle64 _h, uint64 addr) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(FadasIface_FadasCvtYUV_RunMT)(remote_handle64 _h, uint64 addr, uint8_t* src, int srcLen, uint8_t* dst, int dstLen, FadasIface_FadasImgProps_t* srcProps, FadasIface_FadasImgProps_t* dstProps, FadasIface_FadasROI_t* roi) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(FadasIface_FadasRemap_CreateMapFromMap)(remote_handle64 _h, uint64* mapPtr, uint32_t camWidth, uint32_t camHeight, uint32_t mapWidth, uint32_t mapHeight, const float* mapX, int mapXLen, const float* mapY, int mapYLen, uint32_t mapStride, FadasIface_FadasRemapPipeline_e imgFormat, uint8_t borderConst) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(FadasIface_FadasRemap_CreateMapFromFisheyeCalib)(remote_handle64 _h, uint64* mapPtr, uint32_t camWidth, uint32_t camHeight, const FadasIface_FadasCameraProps_t* camProps, const FadasIface_FadasDistCoeffs_t* distCoeffs, FadasIface_FadasRemapPipeline_e imgFormat, uint32_t mapWidth, uint32_t mapHeight, uint8_t borderConst) __QAIC_HEADER_ATTRIBUTE;
...
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(FadasIface_FadasRemap_Run)(remote_handle64 _h, uint64 mapPtr, const uint8_t* src, int srcLen, const FadasIface_FadasImgProps_t* srcProps, uint8_t* dst, int dstLen, const FadasIface_FadasImgProps_t* dstProps, FadasIface_FadasROI_t* dstROI) __QAIC_HEADER_ATTRIBUTE;
...
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(FadasIface_FadasCvtYUV_Renormalize888)(remote_handle64 _h, int32_t srcFd, const FadasIface_FadasImgProps_t* srcProps, const FadasIface_FadasNormlzParams_t* normlzR, const FadasIface_FadasNormlzParams_t* normlzG, const FadasIface_FadasNormlzParams_t* normlzB, int32_t dstFd, uint32_t dstStride, int32_t batchSize) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(FadasIface_FadasCvtYUV_Renormalize888u8f32)(remote_handle64 _h, int32_t srcFd, const FadasIface_FadasImgProps_t* srcProps, const FadasIface_FadasNormlzParams_t* normlzR, const FadasIface_FadasNormlzParams_t* normlzG, const FadasIface_FadasNormlzParams_t* normlzB, int32_t dstFd, uint32_t dstStride, int32_t batchSize) __QAIC_HEADER_ATTRIBUTE;
