...
#define RPCMEM_HEAP_ID_SEC_CP_NP ( 7 )
...
extern "C"
{
    ...
    /**
     * Add mem(not allocated by rpcmem) to rpcmem list
     * @size, mem size
     * @va, QNX virtual address
     * @phandle, pmem handle of this mem
     * @retval, 0 if success
     */
    extern int rpcmem_add_va( int size, void *va, void *phandle );
...
#define RPCMEM_HEAP_SEC_CP_NP 0x04000000
