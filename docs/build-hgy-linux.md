...
On linux 20.04 host environment, install dependent packages:
...
cd $workspace/linux
sudo chmod +x ./oecore-x86_64-aarch64-toolchain-nodistro.0.sh
sudo ./oecore-x86_64-aarch64-toolchain-nodistro.0.sh -y -d .
